...
# Hacks and tweaks (2a): Try Again. When the player presses the Space bar, the game is reset.
#
...
# Hacks and tweaks 1b: change direction
#
...
def layout_stars(stars_to_layout):
    ...
    for index, star in enumerate(stars_to_layout):
        ...
        # hacks and tweaks - change direction
        if index % 2 == 0:
            star.y = 0
        else:
            star.y = HEIGHT
...
# Hacks and tweaks 1a: change speed
#
...
# Hacks and tweaks (2b): Shuffling
# This function shuffles the stars every second. The function first checks if the stars list isn't empty.
# It then uses a Python feature called list comprehension. This allows you to get each star’s position
# along the x-axis in the form of a list. Once you have this list, you can mix up the values in it.
# Use clock.schedule_interval() to run the shuffle() function once every second.
def shuffle():
    global stars
